...
class WorkerPropertyDB:
    ...
    def get_worker_properties_by_worker_id(
        ...
        try:
            ...
            log_info(
                f"Failed to get worker properties by worker id from database: {e}"
            )
    ...
    def delete_worker_properties_by_worker_id(self, worker_id: str) -> None:
        try:
            ...
            log_info(
                f"Failed to get worker properties by worker id to delete: {e}"
            )
            handle_get_document_error(e)
        try:
...
def core_to_doc_worker_property(
    ...
    try:
        ...
        log_info(
            f"Failed to get worker dimension by id for worker property: {e}"
        )
        handle_get_document_error(e)
    try:
        ...
        log_info(
            f"Failed to convert WorkerProperty to WorkerPropertyDocument: {e}"
        )
...
def doc_to_core_worker_property(
    ...
    try:
        ...
        log_info(
            f"Failed to convert WorkerPropertyDocument to WorkerProperty: {e}"
        )
