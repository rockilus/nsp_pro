...
from models.daily_shift_demand import DailyShiftDemand as DailyShiftDemandDocument
...
from models.team import Team as TeamDocument
...
class DailyShiftDemandDB:
    ...
    def create_daily_shift_demand_daily(
    ...
    def delete_daily_shift_demands_by_schedule_id(self, schedule_id: str) -> None:
        try:
            ...
            log_info("Failed to get daily shift demands by coverage id to delete")
            handle_get_document_error(e)
        try:
