...
from routes.api_model import DimensionMessage, NewDimensionMessage
...
async def create_dimension(
    ...
    try:
        ...
        d_data = api_msg_to_dimension(dimension)
        d_created, properties = create_dimension_service(d_data)
        response = core_to_msg_new_dimension(d_created, properties)
...
def core_to_msg_new_dimension(
    ...
    try:
        ...
        log_info(
            "Failed to convert Dimension and WorkerProperty list or "
...
# message to core
def api_msg_to_dimension(msg: DimensionMessage) -> Dimension:
