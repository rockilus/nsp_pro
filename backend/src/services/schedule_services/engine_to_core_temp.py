...
#                         break
#                     out.append(
#                         _engine_to_core_objective_breach(
#                             ob, assignments, schedule
#                         )
#                     )
#                     break
#         else:
...
#         # Use to fetch constraints from db here
#         constraint = []
...
#     workers = [worker_db.get_worker_by_id(w_id) for w_id in workers_id]
#     s_reference = [
#         shift_db.get_shift_by_id(s_id)
#         for s_id in constraint.shift_var.reference_ids
#     ]
#     s_relative = [
#         shift_db.get_shift_by_id(s_id)
#         for s_id in constraint.shift_var.relative_ids
#     ]
#     a_d_relative = next(
#         (
#             a
