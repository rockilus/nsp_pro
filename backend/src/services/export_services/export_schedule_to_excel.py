...
def export_schedule_to_excel(team_id: str, export_options: ExportOptions) -> str:
    ...
    core_to_excel_schedule(workers, shifts, assignments, dates)

    return "path/to/excel_file.xlsx"
