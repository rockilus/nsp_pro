from scripts.setup_database import constraint_build_db, constraint_db, schedule_db


def delete_constraint_build_and_dependencies(team_id: str, cb_id: str) -> None:
