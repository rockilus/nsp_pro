...
workers = [
    Worker(id="0", team_id="0", name="john", deleted=False),
    Worker(id="1", team_id="0", name="paul", deleted=False),
    Worker(id="2", team_id="0", name="george", deleted=False),
    Worker(id="3", team_id="0", name="ringo", deleted=False),
    Worker(id="4", team_id="0", name="yoko", deleted=False),
    Worker(id="5", team_id="0", name="linda", deleted=False),
    Worker(id="6", team_id="0", name="maureen", deleted=False),
    Worker(id="7", team_id="0", name="pattie", deleted=False),
    Worker(id="8", team_id="0", name="olivia", deleted=False),
    Worker(id="9", team_id="0", name="barbara", deleted=False),
]
