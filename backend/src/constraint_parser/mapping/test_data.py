...
test_data = [
    ...
    # One worker, one shift
    {
        ...
        "in": ConstraintBuild(
            ...
            blocks=[
                ...
                Block(name="text", value_type="string", value="should work"),
                Block(name="operator", value_type="string", value="at most"),
                Block(name="#", value_type="number", value=2),
                Block(name="timing", value_type="string", value="consecutive"),
                Block(
                    name="shift", value_type="dict", value=[{"shifts": "off"}]
                ),
            ],
            text="",
            hard=True,
    ...
    # Boolean property workers, boolean property shifts
    {
        ...
        "in": ConstraintBuild(
            ...
            blocks=[
                Block(
                    name="worker", value_type="dict", value=[{"60+": "60+"}]
                ),
                Block(name="text", value_type="string", value="should work"),
                Block(name="operator", value_type="string", value="at most"),
                Block(name="#", value_type="number", value=2),
    ...
    # Non boolean property worker, non boolean property shift
    {
        ...
        "in": ConstraintBuild(
            ...
            blocks=[
                ...
                Block(name="timing", value_type="string", value="consecutive"),
                Block(
                    name="shift", value_type="dict", value=[{"unit": "unit 1"}]
                ),
            ],
            text="",
            hard=True,
    ...
    # Sum
    {
        ...
        "in": ConstraintBuild(
            ...
            blocks=[
                ...
                Block(name="text", value_type="string", value="should work"),
                Block(name="operator", value_type="string", value="at least"),
                Block(name="#", value_type="number", value=1),
                Block(
                    name="shift", value_type="dict", value=[{"shifts": "off"}]
                ),
                Block(name="timing", value_type="string", value="per week"),
            ],
            text="",
            hard=True,
            priority="medium",
    ...
    # Order
    {
        ...
        "in": ConstraintBuild(
            ...
            template_id="2",
            blocks=[
                Block(name="operator", value_type="string", value="no"),
                Block(
                ...
                Block(name="#", value_type="number", value=1),
                Block(name="text", value_type="string", value="day"),
                Block(name="timing", value_type="string", value="after"),
                Block(
                    name="shift_relative",
                    value_type="dict",
                    value=[{"shifts": "afternoon"}],
                ),
                Block(name="text", value_type="string", value="for"),
                Block(
                    name="worker",
                    value_type="dict",
                    value=[{"workers": "John"}],
    ...
    },
    {
        ...
        "in": ConstraintBuild(
            ...
            template_id="3",
            blocks=[
                Block(name="text", value_type="string", value="if"),
                Block(
                    name="shift_reference",
                    value_type="dict",
                    value=[{"shifts": "night"}],
                ),
                Block(name="text", value_type="string", value="then"),
                Block(
                    name="shift_relative",
                    value_type="dict",
                    value=[{"shifts": "off"}],
    ...
    },
    {
        ...
        "in": ConstraintBuild(
            ...
            blocks=[
                ...
                Block(name="text", value_type="string", value="on"),
                Block(name="weekday", value_type="string", value="saturday"),
                Block(name="text", value_type="string", value="then"),
                Block(
                    name="shift_relative",
                    value_type="dict",
    ...
    },
    {
        ...
        "in": ConstraintBuild(
            ...
            blocks=[
                ...
                Block(name="#", value_type="number", value=2),
                Block(name="text", value_type="string", value="day"),
                Block(name="timing", value_type="string", value="before"),
                Block(name="text", value_type="string", value="for"),
                Block(
                    name="worker",
                    value_type="dict",
    ...
    # Filter
    {
        ...
        "in": ConstraintBuild(
            ...
            blocks=[
                ...
                Block(
                    name="operator", value_type="string", value="should only"
                ),
                Block(name="text", value_type="string", value="work"),
                Block(
                    name="shift",
                    value_type="dict",
                    value=[{"shifts": "night"}],
    ...
    },
    {
        ...
        "in": ConstraintBuild(
            ...
            blocks=[
                ...
                Block(
                    name="operator", value_type="string", value="should not"
                ),
                Block(name="text", value_type="string", value="work"),
                Block(
                    name="shift",
    ...
    # Evenness
    {
        ...
        "in": ConstraintBuild(
            ...
            blocks=[
                ...
                Block(name="text", value_type="string", value="on"),
                Block(name="weekday", value_type="string", value="sunday"),
                Block(
                    name="text",
                    value_type="string",
