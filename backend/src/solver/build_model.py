...
class ModelData:
    def __init__(
        ...
        self.shift_types = ["off"] + list(shift_types_from_db.keys())
...
class BuildModel:
    def __init__(self, model_data: ModelData) -> None:
        ...
        self.model_file_path = (
            "/Users/felipekharaba/Documents"
            + "/Documents – Felipe’s MacBook Pro/Coding courses/Projects"
            + "/nsp_pro/backend/saved_model.proto"
        )
                ...
                for w in range(self.model_data.num_weeks):
                    for d in range(self.model_data.num_days_week):
                        ...
                        if over_penalty > 0:
                            name = (
                                "excess_demand("
                                + f"day={w*self.model_data.num_days_week+d}, "
                                + f"shift={s}, type={t})"
                            )
