...
Provides business logic for creating, reading, updating, and deleting shift demands,
including support for period-based operations and matrix formatting.
"""
...
class ShiftDemandNewService(BaseService):
    ...
    def get_shift_demands_by_period(
        ...
        Args:
            ...
            buffer_days: Additional days to fetch before/after period for navigation
