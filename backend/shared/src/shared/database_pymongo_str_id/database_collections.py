...
from shared.database_pymongo_str_id.repositories.assignment import (
    AssignmentRepository,
)
from shared.database_pymongo_str_id.repositories.attribute import (
    AttributeRepository,
)
from shared.database_pymongo_str_id.repositories.breach import BreachRepository
from shared.database_pymongo_str_id.repositories.config import ConfigRepository
from shared.database_pymongo_str_id.repositories.constraint_build import (
    ConstraintBuildRepository,
)
from shared.database_pymongo_str_id.repositories.coverage import (
    CoverageRepository,
)
from shared.database_pymongo_str_id.repositories.coverage_selector import (
...
from shared.database_pymongo_str_id.repositories.dim_entry import (
    DimEntryRepository,
)
...
from shared.database_pymongo_str_id.repositories.model_output import (
    ModelOutputRepository,
)
from shared.database_pymongo_str_id.repositories.request import (
    RequestRepository,
)
...
from shared.database_pymongo_str_id.repositories.shift_demand import (
    ShiftDemandRepository,
)
from shared.database_pymongo_str_id.repositories.specialty import (
    SpecialtyRepository,
)
from shared.database_pymongo_str_id.repositories.stats_header import (
    StatsHeaderRepository,
)
from shared.database_pymongo_str_id.repositories.team import TeamRepository
from shared.database_pymongo_str_id.repositories.user import UserRepository
from shared.database_pymongo_str_id.repositories.worker import WorkerRepository
