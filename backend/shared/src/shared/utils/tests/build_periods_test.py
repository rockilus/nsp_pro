...
class TestBuildPeriods:
    def test_build_periods_weekly(self) -> None:
    ...
    def test_build_periods_yearly(self) -> None:
        start_date = date(2025, 1, 1)
        end_date = date(2025, 1, 31)
        dates_campaign = [
            start_date + timedelta(days=i)
    ...
    def test_build_periods_weekly_with_hist(self) -> None:
        start_date = date(2025, 1, 1)
        end_date = date(2025, 1, 31)
        dates_campaign = [
            start_date + timedelta(days=i)
        ...
        date_hist_1 = start_date - timedelta(days=1)
        date_hist_2 = start_date - timedelta(days=2)
    ...
    def test_build_periods_monthly_with_hist(self) -> None:
        start_date = date(2025, 1, 1)
        end_date = date(2025, 1, 31)
    ...
    def test_build_periods_yearly_with_hist(self) -> None:
        start_date = date(2025, 1, 1)
        end_date = date(2025, 1, 31)
