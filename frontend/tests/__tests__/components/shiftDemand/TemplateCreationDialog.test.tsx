  ...
  useTranslation: () => ({
    t: (key: string) => {
      const translations: Record<string, string> = {
        ...
        template_description_placeholder: 'Enter a description for this template (optional)',
        cancel: 'Cancel',
...
describe('TemplateCreationDialog', () => {
  ...
  it('handles API errors gracefully', async () => {
    ...
    render(<TemplateCreationDialog {...mockProps} onTemplateCreated={onTemplateCreatedMock} />);
  ...
  it('resets form when dialog is closed', async () => {
    ...
    const { rerender } = render(<TemplateCreationDialog {...mockProps} onClose={onCloseMock} />);
    ...
    rerender(<TemplateCreationDialog {...mockProps} onClose={onCloseMock} open={false} />);
    rerender(<TemplateCreationDialog {...mockProps} onClose={onCloseMock} open={true} />);
