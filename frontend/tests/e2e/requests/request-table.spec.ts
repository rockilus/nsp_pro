...
test.describe('Request Table actions', () => {
  ...
  test('Click on the edit button opens the edit request panel', async ({ page }) => {
    const table = base.getRequestTable(page);
    await expect(table).toBeVisible();

    // Find the first request id by locating the edit button inside the table
    const editButton = await page.locator('[data-testid^="edit-request-button-"]').first();
  ...
  test('Click on the delete button deletes the request', async ({ page }) => {
    ...
    const deleteButton = await page.locator('[data-testid^="delete-request-button-"]').first();
  ...
  test('Click on the checkmark changes the request status to approved', async ({ page }) => {
    const approveButton = await page.locator('[data-testid^="approve-request-button-"]').first();
  ...
  test('Click on the rescind button for an approved request reverts status to pending', async ({
    ...
    const rescindButton = await page.locator('[data-testid^="rescind-request-button-"]').first();
  ...
  test('Click on the close icon changes the request status to rejected', async ({ page }) => {
    const rejectButton = await page.locator('[data-testid^="reject-request-button-"]').first();
