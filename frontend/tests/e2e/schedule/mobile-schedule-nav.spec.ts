...
test.describe("Mobile Schedule Nav - Owner Tests", () => {
  ...
  test("should open settings dialog when tune icon is clicked", async ({
    page,
  }) => {
  ...
  test("should display worker selector for owner in settings dialog", async ({
    page,
  }) => {
  ...
  test("should display MobileWorkerSchedule when 'My schedule' is selected", async ({
    page,
  }) => {
    // Open settings dialog
    const settingsButton = page.locator(
    ...
    await expect(
      page.locator('[data-testid="mobile-schedule-settings-dialog"]'),
    ).not.toBeVisible();
    ...
    console.log(
      "✅ MobileWorkerSchedule displayed when 'My schedule' is selected",
    );
  });

  test("should display MobileTeamSchedule when 'Team schedule' is selected", async ({
    page,
  }) => {
    // Open settings dialog
    const settingsButton = page.locator(
    ...
    const teamViewButton = page.locator(
    ...
    console.log(
      "✅ MobileTeamSchedule displayed when 'Team schedule' is selected",
    );
  });
  ...
  test("should change displayed worker when different worker is selected in 'My schedule' view", async ({
    ...
    const initialWorkerText =
      (await workerSelectButton.textContent())?.trim() || "";
    ...
    const workerOptions = await page
      .locator('[data-testid^="mobile-worker-option-"]')
      .all();
    ...
    console.log(
      `Selecting different worker: ${differentWorkerText} (${differentWorkerId})`,
    );

    // Select the different worker
    await page
      .locator(`[data-testid="mobile-worker-option-${differentWorkerId}"]`)
      .click();
  ...
  test("should persist view selection when reopening settings dialog", async ({
    page,
  }) => {
    ...
    const teamViewButtonReopen = page.locator(
      '[data-testid="mobile-view-team-button"]',
    );
...
test.describe("Mobile Schedule Nav - Member Tests", () => {
  ...
  test("should not display worker selector for member in settings dialog", async ({
    page,
  }) => {
    // Open settings dialog
    const settingsButton = page.locator(
    ...
    console.log(
      "✅ Worker selector correctly hidden for member in settings dialog",
    );
  });

  test("should display view toggle for member in settings dialog", async ({
    page,
  }) => {
    // Open settings dialog
    const settingsButton = page.locator(
  ...
  test("should only display linked worker's schedule in 'My schedule' view for member", async ({
    ...
    console.log(
      "✅ Member can view 'My schedule' showing only their linked worker's assignments",
    );
  });
  ...
  test("should allow member to switch between 'My schedule' and 'Team schedule' views", async ({
    ...
    console.log(
      "✅ Member can switch between 'My schedule' and 'Team schedule' views",
    );
  });
