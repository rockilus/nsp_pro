...
test.describe('TemplateViewer - Build From Demands Feature', () => {
  ...
  test.describe('Dialog Opening and Closing', () => {
    test('should display build from demands button in template toolbar', async ({ page }) => {
    ...
    test('should open build from demands dialog when clicking the button', async ({ page }) => {
      const buildButton = templateTestBase.getBuildFromDemandsButton(page);
      ...
      await expect(page.getByRole('heading', { name: /Build from Demands/i })).toBeVisible();
      await expect(page.getByRole('heading', { name: 'Source Week' })).toBeVisible();
      await expect(page.getByRole('heading', { name: 'Target Week' })).toBeVisible();
    });

    test('should close build from demands dialog when clicking cancel button', async ({ page }) => {
      const formElements = templateTestBase.getBuildFromDemandsFormElements(page);
      ...
      await expect(page.getByTestId('build-from-demands-dialog')).not.toBeVisible();
    });

    test('should close build from demands dialog when pressing Escape key', async ({ page }) => {
      const dialog = templateTestBase.getBuildFromDemandsDialog(page);
  ...
  test.describe('Source Week Selection', () => {
    test('should display date picker for source week selection', async ({ page }) => {
      await templateTestBase.openBuildFromDemandsDialog(page);
    ...
    test('should enable apply button when source week is selected', async ({ page }) => {
      await templateTestBase.openBuildFromDemandsDialog(page);
    ...
    test('should show helper text about Monday calculation', async ({ page }) => {
      await templateTestBase.openBuildFromDemandsDialog(page);
  ...
  test.describe('Target Week Selection', () => {
    test('should display dropdown for target week selection', async ({ page }) => {
      await templateTestBase.openBuildFromDemandsDialog(page);
    ...
    test('should show correct number of target weeks for standard template', async ({ page }) => {
      await templateTestBase.openBuildFromDemandsDialog(page);
    ...
    test('should show overwrite warning for selected target week', async ({ page }) => {
      await templateTestBase.openBuildFromDemandsDialog(page);
  ...
  test.describe('Template Type Handling', () => {
    test('should handle standard template with multiple weeks', async ({ page }) => {
    ...
    test('should handle even/odd template conversion and show appropriate weeks', async ({
      ...
      const confirmDialog = templateTestBase.getEvenOddConversionDialogElements(page);
  ...
  test.describe('Applying Demands', () => {
    test('should successfully apply demands from source to target week', async ({ page }) => {
    ...
    test('should show loading state while applying demands', async ({ page }) => {
      await templateTestBase.openBuildFromDemandsDialog(page);
      ...
      try {
        ...
        console.log('Loading state was too fast to detect, which is normal for fast operations');
      }
    });

    test('should disable cancel and apply buttons during operation', async ({ page }) => {
      await templateTestBase.openBuildFromDemandsDialog(page);
  ...
  test.describe('Validation and Error Handling', () => {
    test('should show error when no source week is selected', async ({ page }) => {
      await templateTestBase.openBuildFromDemandsDialog(page);
    ...
    test('should keep apply button disabled when no source week is selected', async ({ page }) => {
      await templateTestBase.openBuildFromDemandsDialog(page);
  ...
  test.describe('Integration with Template Data', () => {
    test('should update template table after applying demands', async ({ page }) => {
    ...
    test('should handle multiple build operations on same template', async ({ page }) => {
      // First application
      await templateTestBase.applyDemandsFromSourceToTarget(page, '01/15/2024', 0);

      // Second application (should overwrite)
      await templateTestBase.applyDemandsFromSourceToTarget(page, '01/22/2024', 0);
