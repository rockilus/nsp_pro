...
import SwapDetailDialog from "../../../../components/swaps/SwapDetailDialog";
...
export default function SwapsPage() {
  ...
  // Check if user is a leader (simplified - in production would check actual role)
  const isLeader = selectedTeam?.membership?.role === "owner";
