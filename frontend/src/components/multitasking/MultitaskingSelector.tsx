  ...
  return (
    <Box sx={{ p: 2 }}>
      ...
      <Typography variant="body2" color="text.secondary" gutterBottom>
        Select shift demands to see which other shifts can be worked
        concurrently by the same worker.
      </Typography>
            ...
            <CardContent>
              ...
              <FormGroup>
                {allShiftDemandIds.map((shiftDemandId) => {
                  const isSelected =
                    selectedShiftDemands.includes(shiftDemandId);
                    ...
                    <FormControlLabel
                      ...
                      control={
                        <Checkbox
                          checked={isSelected}
                          onChange={() =>
                            handleShiftDemandToggle(shiftDemandId)
                          }
                      ...
                      label={
                        <Typography
                          variant="body2"
                          color={
                            isSelectable ? "text.primary" : "text.disabled"
                          }
                        >
                          {shiftDemandId}
                        </Typography>
            ...
            <CardContent>
              ...
              {selectedShiftDemands.length > 0 ? (
                <>
                  ...
                  <Typography variant="subtitle2" gutterBottom>
                    Additional Compatible Shifts (
                    {compatibleShiftDemands.length}):
                  </Typography>
                  ...
                  >
                    <Typography variant="body2" color="success.contrastText">
                      ...
                      {selectedShiftDemands.length +
                        compatibleShiftDemands.length}{" "}
                      shifts can be assigned to the same worker.
                    </Typography>
                  </Box>
                </>
              ) : (
