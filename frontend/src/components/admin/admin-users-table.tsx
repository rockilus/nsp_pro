...
export default function AdminUsersTable({ users, onAccessAccount }: AdminUsersTableProps) {
  if (users.length === 0) {
    return (
      <Typography data-testid="admin-no-users-message" color="text.secondary" sx={{ mt: 2 }}>
        No users found.
      </Typography>
    );
  }
  ...
  return (
    <TableContainer data-testid="admin-users-table" component={Paper} variant="outlined">
      <Table size="small">
        <TableHead>
          <TableRow>
            <TableCell>
