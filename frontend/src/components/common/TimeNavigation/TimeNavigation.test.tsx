...
describe('TimeNavigation', () => {
  ...
  describe('Period Label Formatting', () => {
    it('should format same month and year correctly', () => {
      ...
      expect(screen.getByTestId('time-nav-label')).toHaveTextContent('January 2025');
    });
    ...
    it('should format different months, same year correctly', () => {
      ...
      expect(screen.getByTestId('time-nav-label')).toHaveTextContent('Jan - Feb 2025');
    });
    ...
    it('should format different years correctly', () => {
      ...
      expect(screen.getByTestId('time-nav-label')).toHaveTextContent('Dec 2024 - Jan 2025');
    });
  });
  ...
  describe('Accessibility', () => {
    it('should have proper ARIA labels', () => {
      ...
      expect(screen.getByLabelText('Navigate to previous period')).toBeInTheDocument();
      expect(screen.getByLabelText('Navigate to next period')).toBeInTheDocument();
    ...
    it('should have aria-label on period label with formatted date', () => {
      ...
      expect(screen.getByLabelText('Current period: January 2025')).toBeInTheDocument();
    });
  });
