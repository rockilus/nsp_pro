...
import CoveragesOverlay from "./coverages-overlay";
// Types
import { ShiftDemandT, ColOverlayT, SDOverlayT } from "../../types/coverage";
  ...
  return (
    ...
    >
      <div style={{ position: "relative", width: "100%" }} ref={tableRef}>
        <WeekViewTable lng={lng} dayColWidth={dayColWidth} />
        <CoveragesOverlay
          lng={lng}
